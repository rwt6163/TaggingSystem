...
def inception_resnet_v2_1_base(inputs,
...
def inception_resnet_v2_1(inputs, num_classes=1001, is_training=True,
  ...
  with tf.variable_scope(scope, 'InceptionResnetV2', [inputs],
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      net, end_points = inception_resnet_v2_1_base(inputs, scope=scope,
                                                 activation_fn=activation_fn)
...
inception_resnet_v2_1.default_image_size = 299


def inception_resnet_v2_1_arg_scope(weight_decay=0.00004,
